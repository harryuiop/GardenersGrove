...
public class GardenService {
    ...
    public void addDefaults() {
        ...
        this.saveGarden(new Garden(user1, "Garden 1", null, new Location("New Zealand", "Christchurch"), 1F, true));
        this.saveGarden(new Garden(user2, "Garden 2", null, new Location("New Zealand", "Christchurch"), 2F, true));
    }
