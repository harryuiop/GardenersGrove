...
public class ProfileController extends NavBar {
    ...
    /**
     * Handles GET requests to the view a friend's profile.
     *
     ...
     * @return The friends profile HTML template.
     */
    @GetMapping(VIEW_FRIENDS_PROFILE_URI_STRING)
    public String viewAllFriendsGardens(@PathVariable long friendId, Model model) {
        logger.info("GET {}", viewProfileUri());
