...
/**
 * ISO 3166-1 alpha-2 Country Codes for Country names. Used to allow filtering within API request to
 * only search within the given country.
 */
public enum CountryCode {
    ...
    CountryCode(String countryName, String alphaTwoCode) {
        this.countryName = countryName;
        this.alphaTwoCode = alphaTwoCode;
    }

    /**
     * Get the two character country code from the country's name.
     * To be used in API request to filter data to only search within given country.
     * @param countryName Exact name of the country. Case-insensitive
     * @return ISO 3166-1 alpha-2 Country Code or null if not found.
     */
    public static String getAlphaTwoCountryCodeFromName(String countryName) {
        for (CountryCode countryCode : CountryCode.values()) {
            if (countryCode.countryName.equalsIgnoreCase(countryName)) {
                return countryCode.alphaTwoCode;
            }
        }
        return null;
    }
