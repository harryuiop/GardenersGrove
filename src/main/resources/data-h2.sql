...
VALUES
  (TRUE, '2000-01-01', 'user1@gmail.com', 'Default', 'User',
...
VALUES
  ('Auckland', 'New Zealand', FALSE, 0.0, 0.0, NULL, NULL, NULL),
...
INSERT INTO garden (location_id, name, description, owner_user_id, size, is_garden_public, verified_description,
                    time_created)
VALUES
  (1, 'Default User''s first Garden', 'The first garden created.', 1, 2, TRUE, TRUE, NOW()),
...
VALUES
  (1, 'First plant of Default User''s first Garden', 1, NULL, 'Plant One', '2024-01-01'),
