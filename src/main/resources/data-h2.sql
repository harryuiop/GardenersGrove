...
INSERT INTO garden (location_id, name, description, owner_user_id, size, is_garden_public, verified_description,
                    location_found, time_created)
VALUES (1, 'Default User''s first Garden', 'The first garden created.', 1, 2, TRUE, TRUE, FALSE, NOW()),
       (2, 'Default User''s Second Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (3, 'Default User''s Third Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (4, 'Default User''s Fourth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (5, 'Default User''s Fifth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (6, 'Default User''s Sixth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (7, 'Default User''s Seventh Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (8, 'Default User''s Eighth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (9, 'Default User''s Ninth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (10, 'Default User''s Tenth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (11, 'Default User''s Eleventh Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (12, 'Default User''s Twelfth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (13, 'Default User''s Thirteenth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (14, 'Default User''s Fourteenth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (15, 'Default User''s Fifteenth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (16, 'Default User''s Sixteenth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (17, 'Default User''s Seventeenth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (18, 'Default User''s Eighteenth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (19, 'Default User''s Nineteenth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (20, 'Default User''s Twentieth Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (21, 'Default User''s Twenty First Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (22, 'Default User''s Twenty Second Garden', NULL, 1, NULL, TRUE, TRUE, FALSE, NOW()),
       (23, 'Second User''s First Garden', 'A demonstration garden.', 2, 0.5, FALSE, TRUE, FALSE, NOW()),
