...
VALUES (1.083, 45.2, 65.5, 25.0, 24.0, 1, NOW()),
       (1.157, 70.0, 40.5, 55.0, 20.0, 1, NOW()),
       (1.091, 33.4, 78.9, 45.3, 20.0, 1, NOW() - INTERVAL '10' MINUTE),
       (1.121, 29.8, 60.7, 71.2, 20.0, 1, NOW() - INTERVAL '15' MINUTE),
       (1.067, 50.5, 23.6, 67.3, 20.0, 1, NOW() - INTERVAL '20' MINUTE),
       (1.105, 72.3, 48.1, 43.8, 20.0, 1, NOW() - INTERVAL '25' MINUTE),
       (1.142, 79.4, 67.9, 35.0, 20.0, 1, NOW() - INTERVAL '30' MINUTE),
       (1.098, 58.7, 9.0, 61.3, 30.0, 1, NOW() - INTERVAL '35' MINUTE),
       (1.024, 62.5, 72.2, 20.0, 25.0, 1, NOW() - INTERVAL '40' MINUTE),
       (1.177, 39.2, 43.3, 28.7, 20.0, 1, NOW() - INTERVAL '45' MINUTE),
       (1.020, 53.9, 44.1, 30.5, 20.0, 1, NOW() - INTERVAL '50' MINUTE),
       (1.082, 77.8, 56.0, 58.0, 20.0, 1, NOW() - INTERVAL '55' MINUTE),
       (1.110, 61.0, 35.7, 64.4, 10.0, 1, NOW() - INTERVAL '60' MINUTE),
       (1.065, 55.3, 33.5, 27.6, 8.0, 1, NOW() - INTERVAL '65' MINUTE),
       (1.124, 75.5, 39.4, 20.1, 15.0, 1, NOW() - INTERVAL '70' MINUTE),
       (1.095, 69.2, 45.8, 31.2, 0.0, 1, NOW() - INTERVAL '75' MINUTE),
       (1.041, 50.0, 11.3, 72.1, 7.3, 1, NOW() - INTERVAL '80' MINUTE),
       (1.089, 74.7, 34.0, 41.2, 40.0, 1, NOW() - INTERVAL '85' MINUTE),
       (1.070, 68.3, 53.2, 24.6, 30.0, 1, NOW() - INTERVAL '90' MINUTE),
       (1.025, 78.0, 63.9, 21.9, 11.0, 1, NOW() - INTERVAL '95' MINUTE),
       (1.138, 49.1, 41.4, 30.3, 12.0, 1, NOW() - INTERVAL '100' MINUTE),
       (1.078, 70.9, 54.8, 60.4, 12.0, 1, NOW() - INTERVAL '105' MINUTE),
       (1.034, 63.5, 47.6, 20.0, 12.0, 1, NOW() - INTERVAL '110' MINUTE),
       (1.099, 65.8, 36.9, 74.2, 11.5, 1, NOW() - INTERVAL '115' MINUTE),
       (1.080, 42.3, 49.3, 52.5, 9.0, 1, NOW() - INTERVAL '120' MINUTE),
       (1.054, 30.9, 62.1, 45.7, 15.0, 1, NOW() - INTERVAL '125' MINUTE),
       (1.112, 78.4, 71.6, 38.4, 18.0, 1, NOW() - INTERVAL '130' MINUTE),
       (1.093, 35.8, 55.5, 48.3, 12.0, 1, NOW() - INTERVAL '135' MINUTE),
       (1.076, 57.0, 39.2, 63.7, 12.0, 1, NOW() - INTERVAL '140' MINUTE),
       (1.043, 64.2, 52.8, 37.5, 12.0, 1, NOW() - INTERVAL '145' MINUTE),
       (1.051, 75.1, 48.3, 29.9, 11.5, 1, NOW() - INTERVAL '150' MINUTE),
       (1.071, 47.2, 15.4, 55.0, 7.5, 1, NOW() - INTERVAL '155' MINUTE),
       (1.029, 34.8, 64.1, 26.6, 15.0, 1, NOW() - INTERVAL '160' MINUTE),
       (1.095, 66.4, 75.0, 58.2, 18.0, 1, NOW() - INTERVAL '165' MINUTE),
       (1.062, 48.5, 41.7, 28.1, 11.0, 1, NOW() - INTERVAL '170' MINUTE),
       (1.044, 55.9, 22.0, 30.0, 9.0, 1, NOW() - INTERVAL '175' MINUTE),
       (1.132, 71.2, 58.0, 34.0, 10.0, 1, NOW() - INTERVAL '180' MINUTE);
