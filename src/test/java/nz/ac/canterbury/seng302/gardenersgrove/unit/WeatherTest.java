...
public class WeatherTest {
    ...
    static Stream<List<WeatherData>> weatherDataProviderSunny() {
        List<WeatherData> sunnyAdvice1 = Arrays.asList(sunny1, sunny1, sunny1);
        List<WeatherData> sunnyAdvice2 = Arrays.asList(sunny1, sunny2, sunny2);
        List<WeatherData> sunnyAdvice3 = Arrays.asList(sunny1, sunny3, sunny3);
        List<WeatherData> sunnyAdvice4 = Arrays.asList(sunny2, sunny2, other1);
        List<WeatherData> sunnyAdvice5 = Arrays.asList(sunny2, sunny3, other2);
        List<WeatherData> sunnyAdvice6 = Arrays.asList(sunny3, sunny3, other3);
    ...
    static Stream<List<WeatherData>> weatherDataProviderRainy() {
        List<WeatherData> rainyAdvice1 = Arrays.asList(rainy1, sunny1, rainy1);
        List<WeatherData> rainyAdvice2 = Arrays.asList(rainy1, sunny2, rainy2);
        List<WeatherData> rainyAdvice3 = Arrays.asList(rainy1, sunny3, rainy3);
        List<WeatherData> rainyAdvice4 = Arrays.asList(rainy1, other1, rainy4);
        List<WeatherData> rainyAdvice5 = Arrays.asList(rainy1, other2, rainy5);
        List<WeatherData> rainyAdvice6 = Arrays.asList(rainy2, other3, rainy2);
        List<WeatherData> rainyAdvice7 = Arrays.asList(rainy2, other3, rainy3);
        List<WeatherData> rainyAdvice8 = Arrays.asList(rainy2, rainy2, rainy4);
        List<WeatherData> rainyAdvice9 = Arrays.asList(rainy2, rainy3, rainy5);
        List<WeatherData> rainyAdvice10 = Arrays.asList(rainy3, sunny2,rainy3);
        List<WeatherData> rainyAdvice11 = Arrays.asList(rainy3, other3, rainy4);
        List<WeatherData> rainyAdvice12 = Arrays.asList(rainy3, other1, rainy5);
        List<WeatherData> rainyAdvice13 = Arrays.asList(rainy4, other3, rainy4);
        List<WeatherData> rainyAdvice14 = Arrays.asList(rainy4, sunny3, rainy5);
        List<WeatherData> rainyAdvice15 = Arrays.asList(rainy5, sunny1, rainy5);
    ...
    static Stream<List<WeatherData>> weatherDataProviderOther() {
        List<WeatherData> otherAdvice1 = Arrays.asList(sunny1, rainy1, sunny1);
        List<WeatherData> otherAdvice2 = Arrays.asList(sunny1, other1, sunny2);
        List<WeatherData> otherAdvice3 = Arrays.asList(rainy1, other1, sunny3);
        List<WeatherData> otherAdvice4 = Arrays.asList(other1, other1, sunny1);
        List<WeatherData> otherAdvice5 = Arrays.asList(sunny2, rainy2, sunny2);
        List<WeatherData> otherAdvice6 = Arrays.asList(sunny2, other2, other3);
        List<WeatherData> otherAdvice7 = Arrays.asList(rainy2, other2, other1);
        List<WeatherData> otherAdvice8 = Arrays.asList(other2, other2, other2);
        List<WeatherData> otherAdvice9 = Arrays.asList(sunny3, rainy3, other3);
        List<WeatherData> otherAdvice10 = Arrays.asList(sunny3, other3, sunny1);
        List<WeatherData> otherAdvice11 = Arrays.asList(rainy3, other3, sunny3);
        List<WeatherData> otherAdvice12 = Arrays.asList(other3, other3, sunny2);
        List<WeatherData> otherAdvice13 = Arrays.asList(sunny1, other3, sunny1);
        List<WeatherData> otherAdvice14 = Arrays.asList(rainy3, other3, other1);
